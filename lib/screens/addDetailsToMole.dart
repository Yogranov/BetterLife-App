...
class AddDetailsToMole extends StatefulWidget {
  
  User user;
  int moleId;

  AddDetailsToMole({this.user, this.moleId});

  @override
  _AddDetailsToMole createState() => _AddDetailsToMole();
}

class _AddDetailsToMole extends State<AddDetailsToMole> {
